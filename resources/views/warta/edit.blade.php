    ...
    <div class="flex min-h-screen relative">
        ...
        <div class="flex-1 flex flex-col md:ml-64">
            ...
            <div class="p-4 hidden md:block">
                <h1 class="text-2xl font-bold text-gray-900">Ubah Warta</h1>
            </div>
            ...
            <main class="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div class="w-full max-w-4xl bg-white p-10 rounded-2xl shadow-xl">
                    <h2 class="text-3xl font-bold text-center text-gray-900 mb-10">Ubah Warta</h2>

                    <form action="{{ route('warta.update', $warta) }}" method="POST" enctype="multipart/form-data"
                        class="space-y-6">
                        @csrf
                        ...
                        @if ($warta->warta_file)
                            <div class="mt-4">
                                ...
                                <div class="rounded-lg border border-gray-300 bg-gray-50 p-4 shadow-sm">
                                    <a href="{{ asset('uploads/' . $warta->warta_file) }}" target="_blank"
