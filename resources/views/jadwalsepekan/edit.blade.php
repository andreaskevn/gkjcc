    ...
    <div class="flex min-h-screen relative">
        ...
        <div class="flex-1 flex flex-col md:ml-64">
            ...
            <div class="p-4 hidden md:block">
                <h1 class="text-2xl font-bold text-gray-900">Ubah Jadwal Sepekan</h1>
            </div>
            ...
            <main class="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div class="w-full max-w-4xl bg-white p-10 rounded-2xl shadow-xl">
                    <h2 class="text-3xl font-bold text-center text-gray-900 mb-10">Ubah Jadwal Sepekan</h2>

                    <form action="{{ route('jadwalsepekan.update', $jadwalsepekan->id) }}" method="POST"
                        ...
                        <div>
                            ...
                            <input type="text" name="weekly_schedule_name" id="weekly_schedule_name"
                                value="{{ old('weekly_schedule_name', $jadwalsepekan->weekly_schedule_name) }}"
                                required
                        ...
                        <div class="mb-4 flex gap-4">
                            <div class="w-1/2">
                                ...
                                <input type="time" name="weekly_schedule_hour" id="weekly_schedule_hour"
                                    value="{{ old('weekly_schedule_hour', \Carbon\Carbon::parse($jadwalsepekan->weekly_schedule_hour)->format('H:i')) }}"
                            ...
                            <div class="w-1/2">
                                ...
                                <select name="weekly_schedule_day" id="weekly_schedule_day" required
                                    ...
                                    @foreach (['Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu', 'Minggu'] as $hari)
                                        <option value="{{ $hari }}"
                                            {{ $jadwalsepekan->weekly_schedule_day == $hari ? 'selected' : '' }}>
                                            {{ $hari }}
                                        </option>
                                    @endforeach
                                </select>
