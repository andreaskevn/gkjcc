                            ...
                            @foreach ($jadwalibadah as $item)
                                <div class="bg-white rounded-lg shadow-md mb-4 p-4">
                                    ...
                                    <div class="grid grid-cols-1 gap-4 text-left">
                                        <p><span class="font-semibold">Hari:</span> {{ $item->worship_schedule_day }}
                                        </p>
                                        <p><span class="font-semibold">Jam:</span> {{ $item->worship_schedule_hour }}
                                        </p>
                                        <p><span class="font-semibold">Bahasa:</span>
                                            {{ $item->worship_schedule_language }}</p>
                                        <p><span class="font-semibold">Kategori:</span>
                                            {{ $item->category->worship_schedule_category_name }}</p>
                                        <p><span class="font-semibold">Pendeta:</span> {{ $item->pastor->pastor_name }}
                                        </p>
                                    </div>
                                    <div class="flex gap-2 mt-4">
                                        ...
                                        <form action="{{ route('jadwalibadah.destroy', $item->id) }}" method="POST"
                                            ...
                                            <button type="button"
                                                ...
                                                data-id="{{ $item->id }}"
                                                data-name="{{ $item->worship_schedule_name }}">
                                                Hapus
                                            </button>
                                        </form>
                                    </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    Swal.fire({
                        title: `Apakah anda yakin ingin menghapus jadwal ibadah ${penggunaName}?`,
