    ...
    <div class="flex min-h-screen relative">
        ...
        <div class="flex-1 flex flex-col md:ml-64">
            ...
            <header
                ...
                <h1 class="text-lg font-semibold">GKJCC | Paduan Suara</h1>
                ...
                <div class="bg-white shadow-xl rounded-2xl overflow-hidden mb-6">
                    ...
                    <div class="bg-gradient-to-r from-blue-600 to-purple-600 p-6">
                        <div class="flex justify-between items-center">
                            <h1 class="text-2xl font-bold text-white">Daftar Paduan Suara</h1>
                            <a href="{{ route('choir.create') }}"
                    ...
                    <div class="p-6">
                            ...
                            <table class="w-full hidden md:table">
                                <thead>
                                    <tr class="bg-gray-100 text-left text-sm font-semibold uppercase tracking-wide">
                                        <th class="py-3 px-6 text-left">Nama Paduan Suara</th>
                                ...
                                <tbody>
                                    @foreach ($choir as $item)
                                        <tr class="border-b border-gray-300 hover:bg-gray-50 transition duration-200">
                                            <td class="py-3 px-6">{{ $item->choir_name }}</td>
                                            <td class="py-3 px-6">{{ $item->users->name }}</td>
                                            <td class="py-3 px-6">
                                                <a href="{{ route('choir.edit', $item->id) }}"
                                                ...
                                                <form action="{{ route('choir.destroy', $item->id) }}"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-id="{{ $item->id }}"
                                                        data-name="{{ $item->choir_name }}">Hapus</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
                        ...
                        <div class="mt-6 flex justify-center">
                            {{ $choir->appends(['search' => request('search'), 'limit' => request('limit')])->links('pagination::tailwind') }}
                        </div>
                    </div>
                </div>
            </main>
