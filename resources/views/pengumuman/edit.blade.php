    ...
    <div class="flex min-h-screen relative">
        ...
        <div class="flex-1 flex flex-col md:ml-64">
            ...
            <div class="p-4 hidden md:block">
                <h1 class="text-2xl font-bold text-gray-900">Ubah Pengumuman</h1>
            </div>
            ...
            <main class="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div class="w-full max-w-4xl bg-white p-10 rounded-2xl shadow-xl">
                    <h2 class="text-3xl font-bold text-center text-gray-900 mb-10">Ubah Pengumuman</h2>
                    ...
                    <form action="{{ route('pengumuman.update', $pengumuman) }}" method="POST"
                        ...
                        <div>
                            ...
                            <input type="text" name="information_title" id="information_title"
                                value="{{ $pengumuman->information_title }}" required
                        ...
                        <div>
                            <label for="information_description"
                                class="block text-gray-700 text-sm font-medium">Deskripsi Pengumuman</label>
                            <textarea name="information_description" id="information_description" rows="6"
                                class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                required>{{ old('information_description', $pengumuman->information_description) }}</textarea>
                        ...
                        @if ($pengumuman->information_head_cover)
                            <div class="mt-4">
                                ...
                                <img src="{{ asset('img/' . $pengumuman->information_head_cover) }}" alt="Current cover"
                                    class="w-40 mt-2 rounded-md border border-gray-300 shadow">
                            </div>
                        @endif

                        <div class="mt-6 flex justify-between gap-4">
                            <button type="button" onclick="window.location='{{ route('pengumuman') }}'"
