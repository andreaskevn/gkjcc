    ...
    <div class="flex min-h-screen relative">
        ...
        <div class="flex-1 flex flex-col md:ml-64">
            ...
            <div class="p-4 hidden md:block">
                <h1 class="text-2xl font-bold text-gray-900">Tambah Beasiswa</h1>
            </div>
            ...
            <main class="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div class="w-full max-w-4xl bg-white p-10 rounded-2xl shadow-xl">
                    <h2 class="text-3xl font-bold text-center text-gray-900 mb-10">Tambah Beasiswa</h2>
                    ...
                    <form action="{{ route('scholarship.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div>
                            <label for="scholarship_title" class="block text-gray-700 text-sm font-medium">Nama
                                Beasiswa</label>
                        ...
                        <div>
                            <label for="scholarship_description"
                                class="block text-gray-700 text-sm font-medium">Deskripsi Beasiswa</label>
                            <textarea name="scholarship_description" id="scholarship_description" rows="6"
                                class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                required>{{ old('scholarship_description') }}</textarea>
                        ...
                        <div class="mt-6 flex justify-between gap-4">
                            <button type="button" onclick="window.location='{{ route('scholarship') }}'"
