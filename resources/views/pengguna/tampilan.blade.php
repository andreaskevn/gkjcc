    ...
    <div class="flex min-h-screen relative">
        ...
        <div class="flex-1 flex flex-col md:ml-64 h-screen overflow-y-auto">
            <header
                ...
                <h1 class="text-lg font-semibold">GKJCC | Pengguna</h1>
            ...
            <div class="p-4 hidden md:block">
                <x-header-dashboard>Pengguna</x-header-dashboard>
            </div>
                                ...
                                <tbody>
                                    @foreach ($users as $item)
                                        <tr class="border-b border-gray-300 hover:bg-gray-50 transition duration-200">
                                            ...
                                            <td class="py-3 px-6">{{ $item->role->role_name }}</td>
                                            <td class="py-3 px-6">
                        ...
                        <div class="block md:hidden w-full max-w-screen-sm mx-auto">
                            ...
                            <div class="bg-white rounded-lg shadow-md mb-3 p-3 text-sm">
                                <div class="grid grid-cols-1 gap-4 text-left">
                                    ...
                                    <p><span class="font-semibold">Role:</span> {{ $item->role->role_name }}</p>
                                </div>
                                <div class="flex gap-2 mt-4">
                                    ...
                                    <form action="{{ route('pengguna.destroy', $item->id) }}" method="POST" class="inline delete-form flex-1">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button"
