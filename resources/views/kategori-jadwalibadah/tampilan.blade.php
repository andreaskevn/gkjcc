                ...
                <div class="bg-white shadow-xl rounded-2xl overflow-hidden mb-6">
                    ...
                    <div class="bg-gradient-to-r from-blue-600 to-purple-600 p-6">
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('kategori-jadwalibadah.create') }}"
                                ...
                                <tbody>
                                    @foreach ($category as $item)
                                        <tr class="border-b border-gray-300 hover:bg-gray-50 transition duration-200">
                                            <td class="py-3 px-6">{{ $item->worship_schedule_category_name }}</td>
                                            <td class="py-3 px-6">
                                                ...
                                                <form action="{{ route('kategori-jadwalibadah.destroy', $item->id) }}" method="POST"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-id="{{ $item->id }}"
                                                        data-name="{{ $item->worship_schedule_category_name }}">Hapus</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
