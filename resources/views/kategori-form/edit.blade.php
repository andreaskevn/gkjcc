...
<head>
    ...
    <title>Edit Kategori Kategori Formulir Sakramental</title>
    ...
    <div class="flex min-h-screen relative">
        ...
        <div class="flex-1 flex flex-col md:ml-64">
            ...
            <div class="p-4 hidden md:block">
                <h1 class="text-2xl font-bold text-gray-900">Ubah Kategori Kategori Formulir Sakramental</h1>
            </div>
            ...
            <main class="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div class="w-full max-w-4xl bg-white p-10 rounded-2xl shadow-xl">
                    <h2 class="text-3xl font-bold text-center text-gray-900 mb-10">Ubah Kategori Kategori Formulir
                        Sakramental</h2>

                    <form action="{{ route('kategori-form.update', $category) }}" method="POST"
                        ...
                        <div>
                            ...
                            <input type="text" name="form_category_name" id="form_category_name"
                                value="{{ $category->form_category_name }}" required
