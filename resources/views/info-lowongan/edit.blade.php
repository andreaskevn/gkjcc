    ...
    <div class="flex min-h-screen relative">
        ...
        <div class="flex-1 flex flex-col md:ml-64">
            ...
            <div class="p-4 hidden md:block">
                <h1 class="text-2xl font-bold text-gray-900">Ubah Info Lowongan</h1>
            </div>
            ...
            <main class="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div class="w-full max-w-4xl bg-white p-10 rounded-2xl shadow-xl">
                    <h2 class="text-3xl font-bold text-center text-gray-900 mb-10">Ubah Info Lowongan</h2>

                    <form action="{{ route('info-lowongan.update', $lowongan) }}" method="POST"
                        ...
                        <div>
                            ...
                            <input type="text" name="information_title" id="information_title"
                                value="{{ $lowongan->information_title }}" required
                        ...
                        <div>
                            ...
                            <textarea name="information_description" id="information_description" rows="6"
                                class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                required>{{ old('information_description', $lowongan->information_description) }}</textarea>
                        ...
                        @if ($lowongan->information_head_cover)
                            <div class="mt-4">
                                ...
                                <img src="{{ asset('img/' . $lowongan->information_head_cover) }}" alt="Current cover"
